    ...
    const cardsData = [
        {
            ...
            handle: '@neilstellar',
            date: 'April 20, 2025',
            feedback: 'The AI Article Writer helped me draft professional content in minutes. Saved me tons of time!',
        },
        {
            ...
            handle: '@averywrites',
            date: 'May 10, 2025',
            feedback: 'The Blog Title Generator gave me catchy headlines that doubled my engagement.',
        },
        {
            ...
            handle: '@jordantalks',
            date: 'June 5, 2025',
            feedback: 'AI Image Generation turned my ideas into stunning visuals. No designer needed!',
        },
        {
            ...
            handle: '@samcarter',
            date: 'June 20, 2025',
            feedback: 'Background Removal worked flawlessly—my product shots look super professional now.',
        },
    ];
    ...
    return (
        <> 
          <div className="text-center">
              <h2 className="text-slate-700 text-[42px] font-semibold">Loved by Creater</h2>
              <p className="text-gray-500 max-w-lg mx-auto"> Don't just take oue word for it. here's what our users are saying
              </p>
        </div>
            <style>{`
